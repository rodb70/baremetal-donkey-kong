    ...
    while( 1 )
    {
        ...
        case GAME:
            ...
            if( KEY_DOWN_NOW( BUTTON_UP ) )
            {
                if( mario.row > 0 )
                {
                    if( mario.col > ladder_two.col - 30 && mario.col < ladder_two.col
                            && mario.row > ladder_two.height + mario.height + 8 )
                    {
                        mario.row--;
                        mario.is_left = 2;
                    }
                    else if( mario.col > ladder_one.col - 30 && mario.col < ladder_one.col
                            && mario.row > mario.height + 8 )
                    {
                        mario.row--;
                        mario.is_left = 2;
                    }
            ...
            if( KEY_DOWN_NOW( BUTTON_DOWN ) )
            {
                if( mario.row > 0 )
                {
                    if( mario.col > ladder_two.col - 30 && mario.col < ladder_two.col && mario.row < 125 )
                    {
                        mario.row++;
                        mario.is_left = 2;
                    }
                    else if( mario.col > ladder_one.col - 30 && mario.col < ladder_one.col && mario.row < 75 )
                    {
                        mario.row++;
                        mario.is_left = 2;
                    }
            ...
            else if( !(mario.col > ladder_one.col - 35 && mario.col < ladder_one.col)
                    && mario.row > mario.height + 8 )
            {
            ...
            {
                drawImage3( barrel_level_one.row, barrel_level_one.col, barrel_level_one.width,
                        barrel_level_one.height, barrel_one );
                barrel_level_one.orientation = 1;
            }
            else if( barrel_level_one.orientation == 1 )
            {
                drawImage3( barrel_level_one.row, barrel_level_one.col, barrel_level_one.width,
                        barrel_level_one.height, barrel_two );
                barrel_level_one.orientation = 2;
            }
            else if( barrel_level_one.orientation == 2 )
            {
                drawImage3( barrel_level_one.row, barrel_level_one.col, barrel_level_one.width,
                        barrel_level_one.height, barrel_three );
                barrel_level_one.orientation = 3;
            }
            else
            {
                drawImage3( barrel_level_one.row, barrel_level_one.col, barrel_level_one.width,
                        barrel_level_one.height, barrel_four );
                barrel_level_one.orientation = 0;
            }
            ...
            {
                drawImage3( barrel_level_two.row, barrel_level_two.col, barrel_level_two.width,
                        barrel_level_two.height, barrel_one );
                barrel_level_two.orientation = 1;
            }
            else if( barrel_level_two.orientation == 1 )
            {
                drawImage3( barrel_level_two.row, barrel_level_two.col, barrel_level_two.width,
                        barrel_level_two.height, barrel_two );
                barrel_level_two.orientation = 2;
            }
            else if( barrel_level_two.orientation == 2 )
            {
                drawImage3( barrel_level_two.row, barrel_level_two.col, barrel_level_two.width,
                        barrel_level_two.height, barrel_three );
                barrel_level_two.orientation = 3;
            }
            else
            {
                drawImage3( barrel_level_two.row, barrel_level_two.col, barrel_level_two.width,
                        barrel_level_two.height, barrel_four );
                barrel_level_two.orientation = 0;
            }
            ...
            {
                drawImage3( barrel_level_three.row, barrel_level_three.col, barrel_level_three.width,
                        barrel_level_three.height, barrel_one );
                barrel_level_three.orientation = 1;
            }
            else if( barrel_level_three.orientation == 1 )
            {
                drawImage3( barrel_level_three.row, barrel_level_three.col, barrel_level_three.width,
                        barrel_level_three.height, barrel_two );
                barrel_level_three.orientation = 2;
            }
            else if( barrel_level_three.orientation == 2 )
            {
                drawImage3( barrel_level_three.row, barrel_level_three.col, barrel_level_three.width,
                        barrel_level_three.height, barrel_three );
                barrel_level_three.orientation = 3;
            }
            else
            {
                drawImage3( barrel_level_three.row, barrel_level_three.col, barrel_level_three.width,
                        barrel_level_three.height, barrel_four );
                barrel_level_three.orientation = 0;
            }
            ...
            if( hitBarrel( mario.row, mario.col, mario.height, mario.width, barrel_level_one.row,
                    barrel_level_one.col, barrel_level_one.height, barrel_level_one.width )
                    || hitBarrel( mario.row, mario.col, mario.height, mario.width, barrel_level_two.row,
                            barrel_level_two.col, barrel_level_two.height, barrel_level_two.width )
                    || hitBarrel( mario.row, mario.col, mario.height, mario.width, barrel_level_three.row,
                            barrel_level_three.col, barrel_level_three.height, barrel_level_three.width ) )
            {
                state = LOSE;
            }
            break;
